...
func Get_playlists_idHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
...
func CreateGet_playlists_idTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_playlists_id",
		mcp.WithDescription("Get a Playlist by id"),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_playlists_idHandler(cfg),
	}
}
