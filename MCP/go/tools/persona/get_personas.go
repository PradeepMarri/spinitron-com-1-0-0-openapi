...
func Get_personasHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/personas%s", cfg.BaseURL, queryString)
...
func CreateGet_personasTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("get_personas",
		mcp.WithDescription("Get Personas"),
		mcp.WithString("name", mcp.Description("Filter by Persona name")),
	...
	return models.Tool{
		Definition: tool,
		Handler:    Get_personasHandler(cfg),
	}
}
